...
/**
 * Advance an in-progress sync. Same shape as continue_stageit_deploy.
 */
final class ContinueSyncTool extends AbstractTool
{
	use StageItBootTrait;
	use OperationRunTrait;

	public function getName(): string { return 'continue_stageit_sync'; }

	public function getDescription(): string
	{
		return 'Advance an in-progress sync_stageit by one budget\'s worth of stages. '
	...
	{
		return $this->runOperation('Sync', 'continue', $arguments);
	}
}
